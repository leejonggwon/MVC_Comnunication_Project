				...
				<table style="text-align: center; border: 1px solid #dddddd" class ="table table-borderd">		
					...
					<tr><!-- 사진업로드 -->
						...
						<td>
							<span class="btn btn-default">
								이미지를 업로드하세요 <input type="file" name="memProfile" id="memProfile" >
							</span>
						</td>
					...
					<tr>
						<td colspan ="2">
							...
							<input type="submit" class="btn btn-primary btn pull-right" value="이미지등록" id="memProfileBtn" disabled>				
						</td>
					</tr>
			...
			<form action="${cpath}/member/update" method="post"> <!-- controller위치는 views 바로 아래에 있다 -->
				...
				<table style="text-align: center; border: 1px solid #dddddd" class ="table table-borderd">
					...
					<tr>
						...
						<td colspan ="2"><input value="${mvo.memNickName}" required="required" type="text" name="memNickName" id="memNickName" class="form-control" maxlength="20" placeholder="이름을 입력하세요"></td>				
					</tr>
					<tr>
